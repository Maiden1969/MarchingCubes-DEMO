...
namespace Sdf
{
    public class SdfHalfCapsule : SdfShape
    {
        ...
        {
            return Mathf.Max(SdfCapsule.CapsuleDistance(p, top, down, radius), Vector3.Dot(p - cutPoint, normal));
        }

        public override SdfShapeType Type => SdfShapeType.HalfCapsule;
